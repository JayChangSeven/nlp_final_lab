...
def main():
    ...
    # 真假新闻数据集
    parser.add_argument('--dataset_dir', default='gossip/',  # 修改为GossipCop数据集路径
                        help='dataset directory')
    parser.add_argument('--train_file', default='gossipcop_lines.txt',
                        help='unlabeled text corpus for training')
    parser.add_argument('--test_file', default='gossipcop_doc_topics.txt',
                        help='test corpus for evaluation')
    parser.add_argument('--test_label_file', default='gossipcop_label-0 for fake and 1 for true.txt',
                        help='test corpus ground truth label')
    parser.add_argument('--label_names_file', default='gossip_label_names.txt',
                        help='file containing label names')
